...
XLang brings programming back to HTML itself. It's a language whose syntax is HTML tags — starting from what already exists in HTML instead of inventing something new on top of it. You write logic using simple, readable tags that live alongside your markup. No JavaScript required. No build step. No compiler.

Output is sanitized and interpolation is escaped by default — see the [documentation](https://github.com/adilson889/Xlang/tree/main/docs) for the full security model.
